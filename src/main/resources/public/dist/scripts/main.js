! function(t) {
    ...
    ! function() {
        ...
        t.position = {
                ...
                return b = s(y), y[0].preventDefault && (n.at = "left top"), m = b.width, g = b.height, v = b.offset, _ = t.extend({}, v), t.each(["my", "at"], function() {
                    ...
                    1 === i.length && (i = l.test(i[0]) ? i.concat(["center"]) : c.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = l.test(i[0]) ? i[0] : "center", i[1] = c.test(i[1]) ? i[1] : "center", t = u.exec(i[0]), e = u.exec(i[1]), k[this] = [t ? t[0] : 0, e ? e[0] : 0], n[this] = [d.exec(i[0])[0], d.exec(i[1])[0]]
                }), 1 === C.length && (C[1] = C[0]), "right" === n.at[0] ? _.left += m : "center" === n.at[0] && (_.left += m / 2), "bottom" === n.at[1] ? _.top += g : "center" === n.at[1] && (_.top += g / 2), p = e(k.at, m, g), _.left += p[0], _.top += p[1], this.each(function() {
                    var s, l, c = t(this),
                        u = c.outerWidth(),
                        d = c.outerHeight(),
                        f = i(this, "marginLeft"),
                    ...
                    "right" === n.my[0] ? I.left -= u : "center" === n.my[0] && (I.left -= u / 2), "bottom" === n.my[1] ? I.top -= d : "center" === n.my[1] && (I.top -= d / 2), I.left += P[0], I.top += P[1], o || (I.left = h(I.left), I.top = h(I.top)), s = {
                        marginLeft: f,
                        marginTop: b
                ...
                flip: {
                    ...
                    top: function(t, e) {
                        var i, s, n = e.within,
                            ...
                            m = -2 * e.offset[1];
                        0 > c ? (s = t.top + p + f + m + e.collisionHeight - a - o, (0 > s || s < r(c)) && (t.top += p + f + m)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - h, (i > 0 || r(i) < u) && (t.top += p + f + m))
                    }
                },
                flipfit: {
                    left: function() {
    ...
    t.extend(n.prototype, {
        ...
        _generateHTML: function(t) {
            var e, i, s, n, o, a, r, h, l, c, u, d, p, f, m, g, v, _, b, y, w, x, C, k, D, T, I, P, M, S, E, A, N, O, z, H, W, $, R, F = new Date,
            ...
            for (t.drawMonth = Z, t.drawYear = tt, i = this._get(t, "prevText"), i = U ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - V, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "e" : "w") + "'>" + i + "</span></a>" : Y ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = U ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, Z + V, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "w" : "e") + "'>" + n + "</span></a>" : Y ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (B ? "w" : "e") + "'>" + n + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? Q : L, a = U ? this.formatDate(a, r, this._getFormatConfig(t)) : a, h = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", l = j ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (B ? h : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (B ? "" : h) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), m = this._get(t, "monthNamesShort"), g = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), _ = this._get(t, "selectOtherMonths"), b = this._getDefaultDate(t), y = "", x = 0; x < q[0]; x++) {
                for (C = "", this.maxRows = 4, k = 0; k < q[1]; k++) {
                    ...
                    for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === x ? B ? o : s : "") + (/all|right/.test(T) && 0 === x ? B ? s : o : "") + this._generateMonthYearHeader(t, Z, tt, G, J, x > 0 || k > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", P = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; 7 > w; w++) M = (w + c) % 7, P += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[M] + "'>" + p[M] + "</span></th>";
                    for (I += P + "</tr></thead><tbody>", S = this._getDaysInMonth(tt, Z), tt === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, S)), E = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7, A = Math.ceil((E + S) / 7), N = X && this.maxRows > A ? this.maxRows : A, this.maxRows = N, O = this._daylightSavingAdjust(new Date(tt, Z, 1 - E)), z = 0; N > z; z++) {
                        for (I += "<tr>", H = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(O) + "</td>" : "", w = 0; 7 > w; w++) W = g ? g.apply(t.input ? t.input[0] : null, [O]) : [!0, ""], $ = O.getMonth() !== Z, R = $ && !_ || !W[0] || G && G > O || J && O > J, H += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + ($ ? " ui-datepicker-other-month" : "") + (O.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === O.getTime() && b.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (R ? " " + this._unselectableClass + " ui-state-disabled" : "") + ($ && !v ? "" : " " + W[1] + (O.getTime() === Q.getTime() ? " " + this._currentClass : "") + (O.getTime() === L.getTime() ? " ui-datepicker-today" : "")) + "'" + ($ && !v || !W[2] ? "" : " title='" + W[2].replace(/'/g, "&#39;") + "'") + (R ? "" : " data-handler='selectDay' data-event='click' data-month='" + O.getMonth() + "' data-year='" + O.getFullYear() + "'") + ">" + ($ && !v ? "&#xa0;" : R ? "<span class='ui-state-default'>" + O.getDate() + "</span>" : "<a class='ui-state-default" + (O.getTime() === L.getTime() ? " ui-state-highlight" : "") + (O.getTime() === Q.getTime() ? " ui-state-active" : "") + ($ ? " ui-priority-secondary" : "") + "' href='#'>" + O.getDate() + "</a>") + "</td>", O.setDate(O.getDate() + 1), O = this._daylightSavingAdjust(O);
                        I += H + "</tr>"
                    }
                    Z++, Z > 11 && (Z = 0, tt++), I += "</tbody></table>" + (X ? "</div>" + (q[0] > 0 && k === q[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), C += I
                }
                y += C
            }
    ...
    i.VERSION = "3.3.6", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (/right|left/.test(t)) {
            var r = e.top - o - a.scroll,
                h = e.top + o - a.scroll + s;
            r < a.top ? n.top = a.top - r : h > a.top + a.height && (n.top = a.top + a.height - h)
        } else {
            var l = e.left - o,
                c = e.left + o + i;
            l < a.left ? n.left = a.left - l : c > a.right && (n.left = a.left + a.width - c)
        }
        return n
...
function(t) {
    var e = {
                ...
                init: function() {
                    function e(t) {
                        t.addEventListener("click", function(t) {
                            t.preventDefault(), this.classList.contains("is-active") === !0 ? this.classList.remove("is-active") : this.classList.add("is-active")
                        })
                    }
                    t(window).load(function() {

                        t(".cycloneslider-template-standard .cycloneslider-pager span:nth-of-type(1)").click(function(){
                            t('html,body').animate({scrollTop: t("#company").offset().top},1500);
                        });

                        t(".cycloneslider-template-standard .cycloneslider-pager span:nth-of-type(2)").click(function(){
                            t('html,body').animate({scrollTop: t("#training").offset().top},1500);
                        });

                        t(".cycloneslider-template-standard .cycloneslider-pager span:nth-of-type(3)").click(function(){
                            t('html,body').animate({scrollTop: t("#coaching").offset().top},1500);
                        });

                        t(".cycloneslider-template-standard .cycloneslider-pager span:nth-of-type(4)").click(function(){
                            t('html,body').animate({scrollTop: t("#services").offset().top},1500);
                        });

                        t(".cssload-content, .logo").fadeOut(1e3), t(".c-hamburger").on("click", function() {
                            t(".mobile-menu").toggle(300)
                        }), t("#fedlap > div").hide(), setTimeout(function() {
                            t("#fedlap #logo").show().addClass("animated slideInRight shine"), t("#fedlap #logo-mirror").show().addClass("animated slideInLeft"), t("#fedlap #logo-blueman").show().addClass("animated fadeIn")
                        }, 1500), setTimeout(function() {
                            t("#fedlap > div:nth-child(1)").delay(1500).show().addClass("animated fadeIn")
                        }, 2e3), setTimeout(function() {
                            t("#fedlap > div:nth-child(2)").delay(1500).show().addClass("animated fadeIn")
                        }, 2500), setTimeout(function() {
                            t("#fedlap > div.splitter").delay(5).show().addClass("animated slideInDown")
                        }, 1500), setTimeout(function() {
                            t("#fedlap > div.splitter-mirror").delay(5).show().addClass("animated slideInUp")
                        }, 1500), t("section, #home-splitted-selector").hide(), t("#fedlap .col-xs-6:nth-child(1)").on("click", function() {
                            n = i.find("a.firstpage"), o = n.map(function() {
                                var e = t(t(this).attr("href"));
                                return e.length ? e : void 0
                            }), t("#fedlap").addClass("animated slideOutUp"), t("#home-splitted-selector").hide(), t("#work, #about-us, .backToStart").show(), t(".menu li:not(:nth-child(1),:nth-child(2),:nth-child(3),:nth-child(8),:nth-child(9),:nth-child(10))").hide(), t(".mobile-menu li:not(:nth-child(1),:nth-child(2),:nth-child(3),:nth-child(8),:nth-child(9),:nth-child(10))").hide()
                        }), t("#fedlap .col-xs-6:nth-child(2)").on("click", function() {
                            n = i.find("a.secondpage"), o = n.map(function() {
                                var e = t(t(this).attr("href"));
                                return e.length ? e : void 0
                            }), t("#fedlap").addClass("animated slideOutUp"), t("#home-splitted-selector, section:not(#work)").show(), t(".first").hide(),t(".firstpage").hide(), t(".second").show(), t(".secondpage").show(), t(".menu li:not(:nth-child(1),:nth-child(3),:nth-child(4),:nth-child(5),:nth-child(6),:nth-child(7),:nth-child(8))").hide(), t(".mobile-menu li:not(:nth-child(1),:nth-child(3),:nth-child(4),:nth-child(5),:nth-child(6),:nth-child(7),:nth-child(8))").hide()
                        }), t(".backToStart").on("click", function() {
                            t("#fedlap").show().removeClass("animated slideOutUp").addClass("animated slideInUp"), t("#fedlap > div").show(), setTimeout(function() {
                                t("section").hide(), t(".menu li").show(),t(".menu li a").show(), t(".mobile-menu li").show(),t(".mobile-menu li a").show()
                            }, 1200)
                        }), t(".content-block div.col-md-6").each(function() {
                            var e = t(this).html().trim(),
                                i = e.substr(0, 1);
                            i = '<span class="iniciale">' + i + "</span>";
                            var s = i + e.substr(1);
                            t(this).html(""), t(this).html(s)
                        });
                        var e = t("section#about-us .content-block:nth-child(2) div.col-md-6");
                        e.prepend(t("<div>").addClass("image-in-text hand"));
                        var s = t("section#about-us .content-block:nth-child(4) div.col-md-6");
                        s.prepend(t("<div>").addClass("image-in-text blueman"));
                        var a = t("section#company .content-block:nth-child(2) div.col-md-6");
                        a.prepend(t("<div>").addClass("image-in-text piramyd"))
                    });
                    var i = t(".menu"),
                        s = i.outerHeight() + 15,
                        n = i.find("a"),
                    ...
                    t(window).scroll(function() {
                        var e = t(this).scrollTop() + s,
                            i = o.map(function() {
                                return t(this).offset().top < e ? this : void 0
                            });
                        console.log(i), i = i[i.length - 1];
                        ...
                        n.removeClass("active").filter("[href='#" + a + "']").addClass("active"), t("body").scrollTop() >= window.innerHeight ? t(".page-header").addClass("scrolled-down") : t(".page-header").removeClass("scrolled-down"), t(".content-block, .list-block").each(function() {
                            t("body").scrollTop() >= t(this).offset().top - window.innerHeight ? (t(this).find("h2").removeClass("non-reached"), t(this).find("div").removeClass("non-reached"), t(this).find("ul").removeClass("non-reached")) : (t(this).find("h2").addClass("non-reached"), t(this).find("div").addClass("non-reached"), t(this).find("ul").addClass("non-reached"))
                        })
                    ...
                    for (var a = document.querySelectorAll(".c-hamburger"), r = a.length - 1; r >= 0; r--) {
                        var h = a[r];
                        e(h)
                    }
                    t.easing.jswing = t.easing.swing, t.extend(t.easing, {
                        ...
                        easeInOutBounce: function(e, i, s, n, o) {
                            return o / 2 > i ? .5 * t.easing.easeInBounce(e, 2 * i, 0, n, o) + s : .5 * t.easing.easeOutBounce(e, 2 * i - o, 0, n, o) + .5 * n + s
                        }
                    })
                },
                finalize: function() {}
            ...
            home: {
                init: function() {
                    t(".caption-wrapper").each(function() {
                        var e = t(this);
                        e.append(t("<a>").attr("href", e.parent().parent().find("a").attr("href")).addClass("go-to-page"))
                    })
                },
                finalize: function() {}
            },
