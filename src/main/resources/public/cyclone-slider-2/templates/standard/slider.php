...
<div tabindex="0" class="cycloneslider cycloneslider-template-standard cycloneslider-width-<?php echo esc_attr( $slider_settings['width_management'] ); ?>"
    ...
    >
    <div class="cycloneslider-slides cycle-slideshow" show_prev_next="true"
                    ...
                    <?php if(!empty($slide['title']) or !empty($slide['description'])) : ?>
                        <div class="cycloneslider-caption">
                            <div class = "caption-wrapper">
                                <div class="cycloneslider-caption-title"><?php echo __(wp_kses_post( $slide['title'] ));?></div>
                                <div class="cycloneslider-caption-description"><?php echo __(wp_kses_post( $slide['description'] ));?></div>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
